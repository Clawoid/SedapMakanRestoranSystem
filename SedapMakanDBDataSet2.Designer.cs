...
namespace SedapMakanRestoranSystem {
    ...
    public partial class SedapMakanDBDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/SedapMakanDBDataSet2.xsd";
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string FullName, string Email, string PhoneNumber, string Role, string Password) {
...
namespace SedapMakanRestoranSystem.SedapMakanDBDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([FullName], [Email], [PhoneNumber], [Role], [Password]" +
                ") VALUES (@FullName, @Email, @PhoneNumber, @Role, @Password);\r\nSELECT UserID, Fu" +
                "llName, Email, PhoneNumber, Role, Password FROM Users WHERE (UserID = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [FullName] = @FullName, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [Role] = @Role, [Password] = @Password WHERE (([UserID] = @Original_UserID) AND ([FullName] = @Original_FullName) AND ([Email] = @Original_Email) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)) AND ([Password] = @Original_Password));
SELECT UserID, FullName, Email, PhoneNumber, Role, Password FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, FullName, Email, PhoneNumber, Role, Password FROM dbo.Users";
        ...
        public virtual int Fill(SedapMakanDBDataSet.UsersDataTable dataTable) {
        ...
        public virtual SedapMakanDBDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SedapMakanDBDataSet.UsersDataTable dataTable = new SedapMakanDBDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SedapMakanDBDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserID, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role, string Original_Password) {
        ...
        public virtual int Insert(string FullName, string Email, string PhoneNumber, string Role, string Password) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string Email, string PhoneNumber, string Role, string Password, int Original_UserID, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role, string Original_Password, int UserID) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Email, string PhoneNumber, string Role, string Password, int Original_UserID, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role, string Original_Password) {
            return this.Update(FullName, Email, PhoneNumber, Role, Password, Original_UserID, Original_FullName, Original_Email, Original_PhoneNumber, Original_Role, Original_Password, Original_UserID);
        }
    }
