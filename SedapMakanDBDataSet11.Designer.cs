...
namespace SedapMakanRestoranSystem {
    ...
    public partial class SedapMakanDBDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/SedapMakanDBDataSet11.xsd";
        ...
        public partial class SalesDataTable : global::System.Data.TypedTableBase<SalesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SalesRow AddSalesRow(int UserID, System.DateTime SaleDate, decimal SalePrice, System.TimeSpan SaleTime, string SaleType) {
            ...
            private void InitClass() {
                ...
                this.columnSaleType.MaxLength = 20;
            }
...
namespace SedapMakanRestoranSystem.SedapMakanDBDataSet1TableAdapters {
    ...
    public partial class SalesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Sales] WHERE (([SaleID] = @Original_SaleID) AND ([UserID] = @Original_UserID) AND ([SaleDate] = @Original_SaleDate) AND ([SalePrice] = @Original_SalePrice) AND ([SaleTime] = @Original_SaleTime) AND ((@IsNull_SaleType = 1 AND [SaleType] IS NULL) OR ([SaleType] = @Original_SaleType)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Sales] ([UserID], [SaleDate], [SalePrice], [SaleTime], [SaleType]) VALUES (@UserID, @SaleDate, @SalePrice, @SaleTime, @SaleType);
SELECT SaleID, UserID, SaleDate, SalePrice, SaleTime, SaleType FROM Sales WHERE (SaleID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sales] SET [UserID] = @UserID, [SaleDate] = @SaleDate, [SalePrice] = @SalePrice, [SaleTime] = @SaleTime, [SaleType] = @SaleType WHERE (([SaleID] = @Original_SaleID) AND ([UserID] = @Original_UserID) AND ([SaleDate] = @Original_SaleDate) AND ([SalePrice] = @Original_SalePrice) AND ([SaleTime] = @Original_SaleTime) AND ((@IsNull_SaleType = 1 AND [SaleType] IS NULL) OR ([SaleType] = @Original_SaleType)));
SELECT SaleID, UserID, SaleDate, SalePrice, SaleTime, SaleType FROM Sales WHERE (SaleID = @SaleID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SaleID, UserID, SaleDate, SalePrice, SaleTime, SaleType FROM dbo.Sales";
        ...
        public virtual int Fill(SedapMakanDBDataSet1.SalesDataTable dataTable) {
        ...
        public virtual SedapMakanDBDataSet1.SalesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SedapMakanDBDataSet1.SalesDataTable dataTable = new SedapMakanDBDataSet1.SalesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SedapMakanDBDataSet1.SalesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_SaleID, int Original_UserID, System.DateTime Original_SaleDate, decimal Original_SalePrice, System.TimeSpan Original_SaleTime, string Original_SaleType) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.TimeSpan)(Original_SaleTime));
            if ((Original_SaleType == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_SaleType));
            }
        ...
        public virtual int Insert(int UserID, System.DateTime SaleDate, decimal SalePrice, System.TimeSpan SaleTime, string SaleType) {
        ...
        public virtual int Update(int UserID, System.DateTime SaleDate, decimal SalePrice, System.TimeSpan SaleTime, string SaleType, int Original_SaleID, int Original_UserID, System.DateTime Original_SaleDate, decimal Original_SalePrice, System.TimeSpan Original_SaleTime, string Original_SaleType, int SaleID) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.TimeSpan)(Original_SaleTime));
            if ((Original_SaleType == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(SaleID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int UserID, System.DateTime SaleDate, decimal SalePrice, System.TimeSpan SaleTime, string SaleType, int Original_SaleID, int Original_UserID, System.DateTime Original_SaleDate, decimal Original_SalePrice, System.TimeSpan Original_SaleTime, string Original_SaleType) {
            return this.Update(UserID, SaleDate, SalePrice, SaleTime, SaleType, Original_SaleID, Original_UserID, Original_SaleDate, Original_SalePrice, Original_SaleTime, Original_SaleType, Original_SaleID);
        }
    }
